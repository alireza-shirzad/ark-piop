...
pub(crate) fn msm_u8<V: VariableBaseMSM>(
    mut bases: &[V::MulBase],
    mut scalars: &[u8],
) -> V {
    let chunk_size = match preamble(&mut bases, &mut scalars) {
...
pub(crate) fn msm_u16<V: VariableBaseMSM>(
    mut bases: &[V::MulBase],
    mut scalars: &[u16],
) -> V {
    let chunk_size = match preamble(&mut bases, &mut scalars) {
...
pub(crate) fn msm_u32<V: VariableBaseMSM>(
    mut bases: &[V::MulBase],
    mut scalars: &[u32],
) -> V {
    let chunk_size = match preamble(&mut bases, &mut scalars) {
...
pub(crate) fn msm_u64<V: VariableBaseMSM>(
    mut bases: &[V::MulBase],
    mut scalars: &[u64],
) -> V {
    let chunk_size = match preamble(&mut bases, &mut scalars) {
